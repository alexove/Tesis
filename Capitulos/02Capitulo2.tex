...
\subsubsection{Funciones de la administraci\'on}
...
{{Efectividad_{instalaciones}}} = \frac{Vol_{producido}}{Vol_{programado}} \times{100}
\end{equation}

\begin{equation}\label{eq:calc_efectividad_ventas}
{{Efectividad_{ventas}}} = \frac{Vol_{vendido}}{Vol_{planificado}} \times{100}
\end{equation}
...
\begin{equation}\label{eq:rendimiento_calidad}
    Rendimiento_{Calidad}=\frac{Vol_{\text{producci\'on conforme}}}{Vol_{\text{total producido}}} \times{100}
\end{equation}

\begin{equation}\label{eq:calidad_uso}
    Calidad_{uso}=\frac{\text{Volumen reclamado por calidad (procedente)}}{\text{Volumen total de ventas}} \times{100}
\end{equation}
...
\begin{equation}\label{eq:productividad_mano_obra}
    \text{Productividad}_{\text{mano de obra}}=\frac{Vol_{\text{producci\'on conforme}}}{\text{Horas hombre trabajadas}}
\end{equation}
